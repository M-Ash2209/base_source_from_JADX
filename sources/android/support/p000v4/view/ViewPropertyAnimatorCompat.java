...
public final class ViewPropertyAnimatorCompat {
    ...
    static class ViewPropertyAnimatorListenerApi14 implements ViewPropertyAnimatorListener {
        ...
        public void onAnimationStart(android.view.View r4) {
            ...
            L_0x0020:
                ...
                boolean r2 = r0 instanceof android.support.p000v4.view.ViewPropertyAnimatorListener
                if (r2 == 0) goto L_0x002d
                r1 = r0
                android.support.v4.view.ViewPropertyAnimatorListener r1 = (android.support.p000v4.view.ViewPropertyAnimatorListener) r1
            L_0x002d:
            ...
            L_0x0032:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.p000v4.view.ViewPropertyAnimatorCompat.ViewPropertyAnimatorListenerApi14.onAnimationStart(android.view.View):void");
        }
        ...
        public void onAnimationEnd(android.view.View r4) {
            ...
            L_0x002e:
                r0 = 2113929216(0x7e000000, float:4.2535296E37)
                java.lang.Object r0 = r4.getTag(r0)
                boolean r1 = r0 instanceof android.support.p000v4.view.ViewPropertyAnimatorListener
                if (r1 == 0) goto L_0x003b
                r2 = r0
                android.support.v4.view.ViewPropertyAnimatorListener r2 = (android.support.p000v4.view.ViewPropertyAnimatorListener) r2
            L_0x003b:
            ...
            L_0x0043:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.p000v4.view.ViewPropertyAnimatorCompat.ViewPropertyAnimatorListenerApi14.onAnimationEnd(android.view.View):void");
        }
    ...
    /* renamed from: x */
    public ViewPropertyAnimatorCompat mo3201x(float f) {
        View view = (View) this.mView.get();
        if (view != null) {
            view.animate().x(f);
        }
    ...
    /* renamed from: y */
    public ViewPropertyAnimatorCompat mo3203y(float f) {
        View view = (View) this.mView.get();
        if (view != null) {
            view.animate().y(f);
        }
    ...
    /* renamed from: z */
    public ViewPropertyAnimatorCompat mo3205z(float f) {
        View view = (View) this.mView.get();
        if (view != null && Build.VERSION.SDK_INT >= 21) {
            view.animate().z(f);
        }

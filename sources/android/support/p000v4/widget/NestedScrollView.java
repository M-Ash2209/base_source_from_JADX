...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent, NestedScrollingChild2, ScrollingView {
    ...
    public void computeScroll() {
        ...
        if (this.mScroller.computeScrollOffset()) {
            ...
            int i3 = dispatchNestedPreScroll(0, i2, this.mScrollConsumed, (int[]) null, 1) ? i2 - this.mScrollConsumed[1] : i2;
            if (i3 != 0) {
                int scrollRange = getScrollRange();
                int scrollY = getScrollY();
                int i4 = scrollY;
                ...
                if (!dispatchNestedScroll(0, scrollY2, 0, i3 - scrollY2, (int[]) null, 1)) {
                    int overScrollMode = getOverScrollMode();

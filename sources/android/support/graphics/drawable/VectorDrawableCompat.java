...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    public boolean isStateful() {
        ...
        L_0x0027:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.graphics.drawable.VectorDrawableCompat.isStateful():boolean");
    }
    ...
    public static android.support.graphics.drawable.VectorDrawableCompat create(@android.support.annotation.NonNull android.content.res.Resources r4, @android.support.annotation.DrawableRes int r5, @android.support.annotation.Nullable android.content.res.Resources.Theme r6) {
        /*
            ...
            r0.<init>()
            android.graphics.drawable.Drawable r4 = android.support.p000v4.content.res.ResourcesCompat.getDrawable(r4, r5, r6)
        ...
        public VectorDrawableCompatState(VectorDrawableCompatState vectorDrawableCompatState) {
            ...
            if (vectorDrawableCompatState != null) {
                ...
                if (vectorDrawableCompatState.mVPathRenderer.mFillPaint != null) {
                    Paint unused = this.mVPathRenderer.mFillPaint = new Paint(vectorDrawableCompatState.mVPathRenderer.mFillPaint);
                }
                if (vectorDrawableCompatState.mVPathRenderer.mStrokePaint != null) {
                    Paint unused2 = this.mVPathRenderer.mStrokePaint = new Paint(vectorDrawableCompatState.mVPathRenderer.mStrokePaint);
                }

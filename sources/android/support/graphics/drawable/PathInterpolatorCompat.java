...
public class PathInterpolatorCompat implements Interpolator {
    ...
    private void initPath(Path path) {
        ...
        if (min > 0) {
            ...
            if (((double) Math.abs(this.f3mX[0])) <= 1.0E-5d && ((double) Math.abs(this.f4mY[0])) <= 1.0E-5d) {
                int i3 = min - 1;
                if (((double) Math.abs(this.f3mX[i3] - 1.0f)) <= 1.0E-5d && ((double) Math.abs(this.f4mY[i3] - 1.0f)) <= 1.0E-5d) {
                    int i4 = 0;
                    float f = 0.0f;
                    while (i < min) {
                        float[] fArr2 = this.f3mX;
                        int i5 = i4 + 1;
                        float f2 = fArr2[i4];
                        if (f2 >= f) {
                            fArr2[i] = f2;
            ...
            sb.append(this.f3mX[0]);
            sb.append(",");
            sb.append(this.f4mY[0]);
            sb.append(" end:");
            int i6 = min - 1;
            sb.append(this.f3mX[i6]);
            sb.append(",");
            sb.append(this.f4mY[i6]);

...
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:16:0x007e A[Catch:{ IOException -> 0x00e9 }] */
    ...
    public void connect(int r17, int r18, int r19, int r20, boolean r21, okhttp3.Call r22, okhttp3.EventListener r23) {
        ...
        L_0x0074:
            ...
            r12 = r11
        L_0x0076:
            okhttp3.Route r0 = r7.route     // Catch:{ IOException -> 0x00e9 }
            boolean r0 = r0.requiresTunnel()     // Catch:{ IOException -> 0x00e9 }
            ...
            r5 = r22
            r6 = r23
            r1.connectTunnel(r2, r3, r4, r5, r6)     // Catch:{ IOException -> 0x00e9 }
            java.net.Socket r0 = r7.rawSocket     // Catch:{ IOException -> 0x00e9 }
        ...
        L_0x0099:
            r13 = r17
            r14 = r18
            r7.connectSocket(r13, r14, r8, r9)     // Catch:{ IOException -> 0x00e7 }
            r15 = r20
        L_0x00a2:
            r7.establishProtocol(r10, r15, r8, r9)     // Catch:{ IOException -> 0x00e5 }
            okhttp3.Route r0 = r7.route     // Catch:{ IOException -> 0x00e5 }
            java.net.InetSocketAddress r0 = r0.socketAddress()     // Catch:{ IOException -> 0x00e5 }
            okhttp3.Route r1 = r7.route     // Catch:{ IOException -> 0x00e5 }
            java.net.Proxy r1 = r1.proxy()     // Catch:{ IOException -> 0x00e5 }
            okhttp3.Protocol r2 = r7.protocol     // Catch:{ IOException -> 0x00e5 }
            r9.connectEnd(r8, r0, r1, r2)     // Catch:{ IOException -> 0x00e5 }
        L_0x00b6:
            okhttp3.Route r0 = r7.route
        ...
        L_0x00d0:
            ...
            monitor-enter(r1)
            okhttp3.internal.http2.Http2Connection r0 = r7.http2Connection     // Catch:{ all -> 0x00e1 }
            int r0 = r0.maxConcurrentStreams()     // Catch:{ all -> 0x00e1 }
            r7.allocationLimit = r0     // Catch:{ all -> 0x00e1 }
    ...
    private void connectTls(okhttp3.internal.connection.ConnectionSpecSelector r8) throws java.io.IOException {
        ...
        L_0x0041:
            ...
            r3.check((java.lang.String) r0, (java.util.List<java.security.cert.Certificate>) r5)     // Catch:{ AssertionError -> 0x0112, all -> 0x0110 }
        ...
        L_0x0085:
            ...
            okio.Source r8 = okio.Okio.source((java.net.Socket) r8)     // Catch:{ AssertionError -> 0x0112, all -> 0x0110 }
            okio.BufferedSource r8 = okio.Okio.buffer((okio.Source) r8)     // Catch:{ AssertionError -> 0x0112, all -> 0x0110 }
            r7.source = r8     // Catch:{ AssertionError -> 0x0112, all -> 0x0110 }
            java.net.Socket r8 = r7.socket     // Catch:{ AssertionError -> 0x0112, all -> 0x0110 }
            okio.Sink r8 = okio.Okio.sink((java.net.Socket) r8)     // Catch:{ AssertionError -> 0x0112, all -> 0x0110 }
            okio.BufferedSink r8 = okio.Okio.buffer((okio.Sink) r8)     // Catch:{ AssertionError -> 0x0112, all -> 0x0110 }
    ...
    public String toString() {
        ...
        sb.append(handshake2 != null ? handshake2.cipherSuite() : NetworkManager.TYPE_NONE);
        sb.append(" protocol=");

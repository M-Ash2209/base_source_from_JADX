...
public class FileUtils extends CordovaPlugin {
            ...
            if (!hashSet.contains(str)) {
                ...
                if (str2 != null) {
                    ...
                    if (file.mkdirs() || file.isDirectory()) {
                        ...
                        LOG.m37d(LOG_TAG, "Unable to create root dir for filesystem \"" + str + "\", skipping");
                    }
                } else {
                    LOG.m37d(LOG_TAG, "Unrecognized extra filesystem identifier: " + str);
                }
            }
        }
    }
    ...
    public HashMap<String, String> getAvailableFileSystems(Activity activity) {
        ...
        if (Environment.getExternalStorageState().equals("mounted")) {
            try {
                ...
                LOG.m37d(LOG_TAG, "External storage unavailable, check to see if USB Mass Storage Mode is on");
            }
        }
        return hashMap;
    }
    ...
    public void initialize(CordovaInterface cordovaInterface, CordovaWebView cordovaWebView) {
        ...
        LOG.m40e(LOG_TAG, "File plugin configuration error: Please set AndroidPersistentFileLocation in config.xml to one of \"internal\" (for new applications) or \"compatibility\" (for compatibility with previous versions)");
        activity.finish();
    }
    ...
    public JSONObject requestAllPaths() throws JSONException {
        ...
        if (Environment.getExternalStorageState().equals("mounted")) {
            try {
                ...
                LOG.m37d(LOG_TAG, "Unable to access these paths, most liklely due to USB storage");
            }
        }
        return jSONObject;
    }
    ...
    public void readFileAs(String str, int i, int i2, final CallbackContext callbackContext, final String str2, final int i3) throws MalformedURLException {
        try {
                ...
                filesystemForURL.readFileAtURL(parse, (long) i, (long) i2, new Filesystem.ReadFileCallback() {
                    public void handleData(InputStream inputStream, String str) {
                        ...
                        try {
                            ...
                            LOG.m37d(FileUtils.LOG_TAG, e.getLocalizedMessage());
            ...
            LOG.m37d(LOG_TAG, e2.getLocalizedMessage());
    ...
    public long write(String str, String str2, int i, boolean z) throws FileNotFoundException, IOException, NoModificationAllowedException {
        try {
            ...
            if (filesystemForURL != null) {
                ...
                LOG.m37d("TEST", str + ": " + writeToFileAtURL);
    ...
    public void onRequestPermissionResult(int i, String[] strArr, int[] iArr) throws JSONException {
        ...
        if (andRemove != null) {
            ...
            LOG.m37d(LOG_TAG, "Received permission callback for unknown request code");
        }
    }
}

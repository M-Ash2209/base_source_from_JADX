...
public class SystemWebViewEngine implements CordovaWebViewEngine {
    ...
    protected CordovaInterface f64cordova;
        ...
        if (this.f64cordova == null) {
            ...
            nativeToJsMessageQueue2.addBridgeMode(new NativeToJsMessageQueue.OnlineEventsBridgeMode(new NativeToJsMessageQueue.OnlineEventsBridgeMode.OnlineEventsBridgeModeDelegate() {
                ...
                public void runOnUiThread(Runnable runnable) {
                    SystemWebViewEngine.this.f64cordova.getActivity().runOnUiThread(runnable);
                }
            }));
    ...
    private void initWebViewSettings() {
        ...
        LOG.m37d(TAG, "CordovaWebView is running on device made by: " + str);
    ...
    private void enableRemoteDebugging() {
        try {
            ...
            LOG.m37d(TAG, "You have one job! To turn on Remote Web Debugging! YOU HAVE FAILED! ");
            e.printStackTrace();
        }
    }
    ...
    public void destroy() {
        ...
        if (this.receiver != null) {
            try {
                ...
                LOG.m41e(TAG, "Error unregistering configuration receiver: " + e.getMessage(), (Throwable) e);
            }
        }
    }

...
public class SystemWebChromeClient extends WebChromeClient {
    ...
    public void onExceededDatabaseQuota(String str, String str2, long j, long j2, long j3, WebStorage.QuotaUpdater quotaUpdater) {
        LOG.m39d(LOG_TAG, "onExceededDatabaseQuota estimatedSize: %d  currentQuota: %d  totalUsedQuota: %d", Long.valueOf(j2), Long.valueOf(j), Long.valueOf(j3));
        quotaUpdater.updateQuota(this.MAX_QUOTA);
    }

    public boolean onConsoleMessage(ConsoleMessage consoleMessage) {
        if (consoleMessage.message() != null) {
            LOG.m39d(LOG_TAG, "%s: Line %d : %s", consoleMessage.sourceId(), Integer.valueOf(consoleMessage.lineNumber()), consoleMessage.message());
        }
    ...
    public void openFileChooser(final ValueCallback<Uri> valueCallback, String str, String str2) {
        ...
        intent.setType("*/*");
        this.parentEngine.f64cordova.startActivityForResult(new CordovaPlugin() {
            public void onActivityResult(int i, int i2, Intent intent) {
                Uri data = (intent == null || i2 != -1) ? null : intent.getData();
                LOG.m37d(SystemWebChromeClient.LOG_TAG, "Receive file chooser URL: " + data);
    ...
    public boolean onShowFileChooser(WebView webView, final ValueCallback<Uri[]> valueCallback, WebChromeClient.FileChooserParams fileChooserParams) {
        ...
        try {
                    ...
                    if (i2 == -1 && intent != null) {
                        if (intent.getClipData() != null) {
                            ...
                            for (int i3 = 0; i3 < itemCount; i3++) {
                                ...
                                LOG.m37d(SystemWebChromeClient.LOG_TAG, "Receive file chooser URL: " + uriArr[i3]);
                            }
                        } else if (intent.getData() != null) {
                            uriArr = WebChromeClient.FileChooserParams.parseResult(i2, intent);
                            LOG.m37d(SystemWebChromeClient.LOG_TAG, "Receive file chooser URL: " + uriArr);
                        }
            ...
            LOG.m52w("No activity found to handle file chooser intent.", (Throwable) e);
    ...
    public void onPermissionRequest(PermissionRequest permissionRequest) {
        LOG.m37d(LOG_TAG, "onPermissionRequest: " + Arrays.toString(permissionRequest.getResources()));

...
public class PluginManager {
    ...
    public void exec(String str, String str2, String str3, String str4) {
        ...
        if (plugin == null) {
            String str5 = TAG;
            LOG.m37d(str5, "exec() call to unknown plugin: " + str);
        ...
        try {
            ...
            if (currentTimeMillis2 > ((long) SLOW_EXEC_WARNING_THRESHOLD)) {
                String str6 = TAG;
                LOG.m49w(str6, "THREAD WARNING: exec() call to " + str + "." + str2 + " blocked the main thread for " + currentTimeMillis2 + "ms. Plugin should use CordovaInterface.getThreadPool().");
            }
            if (!execute) {
            ...
            LOG.m41e(TAG, "Uncaught exception from plugin", (Throwable) e);

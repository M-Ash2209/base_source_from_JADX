...
public class CordovaWebViewImpl implements CordovaWebView {
    ...
    public CordovaInterface f60cordova;
    ...
    public void init(CordovaInterface cordovaInterface, List<PluginEntry> list, CordovaPreferences cordovaPreferences) {
        if (this.f60cordova == null) {
            this.f60cordova = cordovaInterface;
            this.preferences = cordovaPreferences;
            this.pluginManager = new PluginManager(this, this.f60cordova, list);
    ...
    public void loadUrlIntoView(final String str, boolean z) {
        ...
        final C05181 r0 = new Runnable() {
            public void run() {
                CordovaWebViewImpl.this.stopLoading();
                LOG.m40e(CordovaWebViewImpl.TAG, "CordovaWebView: TIMEOUT ERROR!");
                JSONObject jSONObject = new JSONObject();
                try {
                    jSONObject.put("errorCode", -6);
                    jSONObject.put(PushConstants.CHANNEL_DESCRIPTION, "The connection to the server was unsuccessful.");
        ...
        final C05192 r5 = new Runnable() {
            public void run() {
                ...
                if (CordovaWebViewImpl.this.loadUrlTimeout == i) {
                    CordovaWebViewImpl.this.f60cordova.getActivity().runOnUiThread(r0);
                }
            }
        };
        final String str2 = str;
        this.f60cordova.getActivity().runOnUiThread(new Runnable() {
            public void run() {
                if (integer > 0) {
                    CordovaWebViewImpl.this.f60cordova.getThreadPool().execute(r5);
                }
    ...
    public void showWebPage(String str, boolean z, boolean z2, Map<String, Object> map) {
        LOG.m39d(TAG, "showWebPage(%s, %b, %b, HashMap)", str, Boolean.valueOf(z), Boolean.valueOf(z2));
        if (z2) {
        ...
        if (!z) {
            ...
            LOG.m49w(TAG, "showWebPage: Refusing to load URL into webview since it is not in the <allow-navigation> whitelist. URL=" + str);
        } else if (!this.pluginManager.shouldOpenExternalUrl(str).booleanValue()) {
            LOG.m49w(TAG, "showWebPage: Refusing to send intent for URL since it is not in the <allow-intent> whitelist. URL=" + str);
        } else {
            try {
                ...
                this.f60cordova.getActivity().startActivity(intent);
            } catch (ActivityNotFoundException e) {
                LOG.m41e(TAG, "Error loading url " + str, (Throwable) e);
            }
        }
    }
    ...
    public void showCustomView(View view, WebChromeClient.CustomViewCallback customViewCallback) {
        LOG.m37d(TAG, "showing Custom View");
    ...
    public void hideCustomView() {
        if (this.mCustomView != null) {
            LOG.m37d(TAG, "Hiding Custom View");
    ...
    public void sendJavascriptEvent(String str) {
        ...
        if (coreAndroid == null) {
            LOG.m49w(TAG, "Unable to fire event without existing plugin");
        } else {
    ...
    protected class EngineClient implements CordovaWebViewEngine.Client {
        ...
        public void onPageStarted(String str) {
            LOG.m37d(CordovaWebViewImpl.TAG, "onPageDidNavigate(" + str + ")");
        ...
        public void onPageFinishedLoading(String str) {
            LOG.m37d(CordovaWebViewImpl.TAG, "onPageFinished(" + str + ")");
            clearLoadTimeoutTimer();
            ...
            if (CordovaWebViewImpl.this.engine.getView().getVisibility() != 0) {
                new Thread(new Runnable() {
                    public void run() {
                        try {
                            Thread.sleep(2000);
                            CordovaWebViewImpl.this.f60cordova.getActivity().runOnUiThread(new Runnable() {
                                public void run() {
            ...
            if (str.equals("about:blank")) {
                CordovaWebViewImpl.this.pluginManager.postMessage(PushConstants.EXIT, (Object) null);
            }
        }
        ...
        public boolean onNavigationAttempt(String str) {
            ...
            LOG.m49w(CordovaWebViewImpl.TAG, "Blocked (possibly sub-frame) navigation to non-allowed URL: " + str);
            return true;
        }
    }
}

...
public class InAppChromeClient extends WebChromeClient {
    ...
    public void onExceededDatabaseQuota(String str, String str2, long j, long j2, long j3, WebStorage.QuotaUpdater quotaUpdater) {
        LOG.m39d(this.LOG_TAG, "onExceededDatabaseQuota estimatedSize: %d  currentQuota: %d  totalUsedQuota: %d", Long.valueOf(j2), Long.valueOf(j), Long.valueOf(j3));
    ...
    public boolean onJsPrompt(WebView webView2, String str, String str2, String str3, JsPromptResult jsPromptResult) {
        ...
        if (str3.startsWith("gap-iab://")) {
            ...
            LOG.m49w(str4, "InAppBrowser callback called with invalid callbackId : " + substring);
            jsPromptResult.cancel();
            return true;
        }
        String str5 = this.LOG_TAG;
        LOG.m49w(str5, "InAppBrowser does not support Cordova API calls: " + str + " " + str3);
        jsPromptResult.cancel();
        return true;
    }
}

...
public final class Detector {
    ...
    public DetectorResult detect() throws NotFoundException {
        ...
        if (i * 4 >= i2 * 7 || i2 * 4 >= i * 7) {
            ...
            bitMatrix = sampleGrid(this.image, resultPoint2, resultPoint13, resultPoint12, resultPoint3, (transitions3 & 1) == 1 ? transitions3 + 1 : transitions3, (transitions4 & 1) == 1 ? transitions4 + 1 : transitions4);
        } else {
            ...
            bitMatrix = sampleGrid(this.image, resultPoint14, resultPoint13, resultPoint12, resultPoint3, i3, i3);
            resultPoint2 = resultPoint14;
        }
    ...
    private static final class ResultPointsAndTransitions {
        ...
        /* renamed from: to */
        private final ResultPoint f23to;
        private final int transitions;

        private ResultPointsAndTransitions(ResultPoint resultPoint, ResultPoint resultPoint2, int i) {
            this.from = resultPoint;
            this.f23to = resultPoint2;
            this.transitions = i;
        }
        ...
        public String toString() {
            return this.from + "/" + this.f23to + '/' + this.transitions;
        }
    }

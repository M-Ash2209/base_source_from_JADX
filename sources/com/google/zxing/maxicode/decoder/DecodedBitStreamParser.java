...
final class DecodedBitStreamParser {
    ...
    /* renamed from: FS */
    private static final char f24FS = '\u001c';

    /* renamed from: GS */
    private static final char f25GS = '\u001d';
    ...
    /* renamed from: NS */
    private static final char f26NS = '￻';
    private static final char PAD = '￼';

    /* renamed from: RS */
    private static final char f27RS = '\u001e';
        ...
        switch (i) {
            ...
            case 3:
                ...
                if (!sb.toString().startsWith("[)>\u001e01\u001d")) {
                    sb.insert(0, str + f25GS + format + f25GS + format2 + f25GS);
                    break;
                } else {
                    sb.insert(9, str + f25GS + format + f25GS + format2 + f25GS);
                    break;
                }
            case 4:

...
public class GoogleSignInOptionsExtensionParcelable extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getBundle", mo6938id = 3)
    private Bundle mBundle;
    @SafeParcelable.Field(getter = "getType", mo6938id = 2)
    private int mType;
    @SafeParcelable.VersionField(mo6944id = 1)
    private final int versionCode;

    @SafeParcelable.Constructor
    GoogleSignInOptionsExtensionParcelable(@SafeParcelable.Param(mo6941id = 1) int i, @SafeParcelable.Param(mo6941id = 2) int i2, @SafeParcelable.Param(mo6941id = 3) Bundle bundle) {
        this.versionCode = i;
        this.mType = i2;
        this.mBundle = bundle;
    }

...
public class GoogleSignInOptions extends AbstractSafeParcelable implements Api.ApiOptions.Optional, ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "isForceCodeForRefreshToken", mo6938id = 6)
    public final boolean zaaa;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "getServerClientId", mo6938id = 7)
    public String zaab;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "getHostedDomain", mo6938id = 8)
    public String zaac;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "getExtensions", mo6938id = 9)
    ...
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "getScopes", mo6938id = 2)
    public final ArrayList<Scope> zaw;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "getAccount", mo6938id = 3)
    public Account zax;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "isIdTokenRequested", mo6938id = 4)
    public boolean zay;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "isServerAuthCodeRequested", mo6938id = 5)
    ...
    GoogleSignInOptions(@SafeParcelable.Param(mo6941id = 1) int i, @SafeParcelable.Param(mo6941id = 2) ArrayList<Scope> arrayList, @SafeParcelable.Param(mo6941id = 3) Account account, @SafeParcelable.Param(mo6941id = 4) boolean z, @SafeParcelable.Param(mo6941id = 5) boolean z2, @SafeParcelable.Param(mo6941id = 6) boolean z3, @SafeParcelable.Param(mo6941id = 7) String str, @SafeParcelable.Param(mo6941id = 8) String str2, @SafeParcelable.Param(mo6941id = 9) ArrayList<GoogleSignInOptionsExtensionParcelable> arrayList2) {

...
public class ResolveAccountResponse extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getConnectionResult", mo6938id = 3)
    private ConnectionResult zadh;
    @SafeParcelable.Field(getter = "getSaveDefaultAccount", mo6938id = 4)
    private boolean zagf;
    @SafeParcelable.VersionField(mo6944id = 1)
    private final int zale;
    @SafeParcelable.Field(mo6938id = 2)
    private IBinder zanw;
    @SafeParcelable.Field(getter = "isFromCrossClientAuth", mo6938id = 5)
    private boolean zapb;

    @SafeParcelable.Constructor
    ResolveAccountResponse(@SafeParcelable.Param(mo6941id = 1) int i, @SafeParcelable.Param(mo6941id = 2) IBinder iBinder, @SafeParcelable.Param(mo6941id = 3) ConnectionResult connectionResult, @SafeParcelable.Param(mo6941id = 4) boolean z, @SafeParcelable.Param(mo6941id = 5) boolean z2) {
        this.zale = i;
        this.zanw = iBinder;

...
public final class StringToIntConverter extends AbstractSafeParcelable implements FastJsonResponse.FieldConverter<String, Integer> {
    ...
    @SafeParcelable.Field(getter = "getSerializedMap", mo6938id = 2)
    private final ArrayList<zaa> zapn;

    @SafeParcelable.Constructor
    StringToIntConverter(@SafeParcelable.Param(mo6941id = 1) int i, @SafeParcelable.Param(mo6941id = 2) ArrayList<zaa> arrayList) {
        this.zale = i;
    ...
    public static final class zaa extends AbstractSafeParcelable {
        ...
        @SafeParcelable.Constructor
        zaa(@SafeParcelable.Param(mo6941id = 1) int i, @SafeParcelable.Param(mo6941id = 2) String str, @SafeParcelable.Param(mo6941id = 3) int i2) {
            this.versionCode = i;
            this.zapo = str;
            this.zapp = i2;
        }

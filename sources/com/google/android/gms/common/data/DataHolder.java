...
public final class DataHolder extends AbstractSafeParcelable implements Closeable {
    ...
    @SafeParcelable.VersionField(mo6944id = 1000)
    private final int zale;
    @SafeParcelable.Field(getter = "getColumns", mo6938id = 1)
    private final String[] zalp;
    private Bundle zalq;
    @SafeParcelable.Field(getter = "getWindows", mo6938id = 2)
    private final CursorWindow[] zalr;
    @SafeParcelable.Field(getter = "getStatusCode", mo6938id = 3)
    private final int zals;
    @SafeParcelable.Field(getter = "getMetadata", mo6938id = 4)
    ...
    DataHolder(@SafeParcelable.Param(mo6941id = 1000) int i, @SafeParcelable.Param(mo6941id = 1) String[] strArr, @SafeParcelable.Param(mo6941id = 2) CursorWindow[] cursorWindowArr, @SafeParcelable.Param(mo6941id = 3) int i2, @SafeParcelable.Param(mo6941id = 4) Bundle bundle) {
        this.mClosed = false;
        this.zalw = true;
        this.zale = i;
        this.zalp = strArr;

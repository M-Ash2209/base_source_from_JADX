...
public final class WebImage extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getWidth", mo6938id = 3)
    private final int zand;
    @SafeParcelable.Field(getter = "getHeight", mo6938id = 4)
    private final int zane;
    @SafeParcelable.Field(getter = "getUrl", mo6938id = 2)
    private final Uri zanf;

    @SafeParcelable.Constructor
    WebImage(@SafeParcelable.Param(mo6941id = 1) int i, @SafeParcelable.Param(mo6941id = 2) Uri uri, @SafeParcelable.Param(mo6941id = 3) int i2, @SafeParcelable.Param(mo6941id = 4) int i3) {
        this.zale = i;
        this.zanf = uri;
        this.zand = i2;
        this.zane = i3;

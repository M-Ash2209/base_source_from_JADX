...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getErrorCode", mo6938id = 2)
    private final int zzh;
    @SafeParcelable.Field(getter = "getResolution", mo6938id = 3)
    private final PendingIntent zzi;
    @SafeParcelable.Field(getter = "getErrorMessage", mo6938id = 4)
    private final String zzj;

    @SafeParcelable.Constructor
    ConnectionResult(@SafeParcelable.Param(mo6941id = 1) int i, @SafeParcelable.Param(mo6941id = 2) int i2, @SafeParcelable.Param(mo6941id = 3) PendingIntent pendingIntent, @SafeParcelable.Param(mo6941id = 4) String str) {
        this.zzg = i;
        this.zzh = i2;
    ...
    public final String toString() {
        return Objects.toStringHelper(this).add("statusCode", zza(this.zzh)).add("resolution", this.zzi).add(PushConstants.MESSAGE, this.zzj).toString();
    }

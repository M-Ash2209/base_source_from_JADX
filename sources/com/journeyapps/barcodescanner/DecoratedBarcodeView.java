...
public class DecoratedBarcodeView extends FrameLayout {
    ...
    private void initialize(AttributeSet attributeSet) {
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, C0369R.styleable.zxing_view);
        int resourceId = obtainStyledAttributes.getResourceId(C0369R.styleable.zxing_view_zxing_scanner_layout, C0369R.layout.zxing_barcode_scanner);
        obtainStyledAttributes.recycle();
        inflate(getContext(), resourceId, this);
        this.barcodeView = (BarcodeView) findViewById(C0369R.C0370id.zxing_barcode_surface);
        BarcodeView barcodeView2 = this.barcodeView;
        if (barcodeView2 != null) {
            barcodeView2.initializeAttributes(attributeSet);
            this.viewFinder = (ViewfinderView) findViewById(C0369R.C0370id.zxing_viewfinder_view);
            ViewfinderView viewfinderView = this.viewFinder;
            if (viewfinderView != null) {
                viewfinderView.setCameraPreview(this.barcodeView);
                this.statusView = (TextView) findViewById(C0369R.C0370id.zxing_status_view);
                return;
            }
    ...
    public void initializeFromIntent(Intent intent) {
        ...
        this.barcodeView.setDecoderFactory(new DefaultDecoderFactory(parseDecodeFormats, parseDecodeHints, stringExtra2));
    }
    ...
    public BarcodeView getBarcodeView() {
        return (BarcodeView) findViewById(C0369R.C0370id.zxing_barcode_surface);
    }

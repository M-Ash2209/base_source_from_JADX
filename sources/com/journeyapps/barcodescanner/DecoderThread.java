...
public class DecoderThread {
    ...
    private final Handler.Callback callback = new Handler.Callback() {
        public boolean handleMessage(Message message) {
            if (message.what != C0369R.C0370id.zxing_decode) {
                return true;
            }
        ...
        public void onPreview(SourceData sourceData) {
            synchronized (DecoderThread.this.LOCK) {
                if (DecoderThread.this.running) {
                    DecoderThread.this.handler.obtainMessage(C0369R.C0370id.zxing_decode, sourceData).sendToTarget();
                }
            }
        }
    };
    ...
    public void decode(SourceData sourceData) {
        ...
        if (decode != null) {
            ...
            if (this.resultHandler != null) {
                Message obtain = Message.obtain(this.resultHandler, C0369R.C0370id.zxing_decode_succeeded, new BarcodeResult(decode, sourceData));
            ...
            if (handler2 != null) {
                Message.obtain(handler2, C0369R.C0370id.zxing_decode_failed).sendToTarget();
            }
        }
        if (this.resultHandler != null) {
            Message.obtain(this.resultHandler, C0369R.C0370id.zxing_possible_result_points, this.decoder.getPossibleResultPoints()).sendToTarget();
        }
        requestNextPreview();
    }
}

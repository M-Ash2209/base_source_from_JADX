...
public class CameraPreview extends ViewGroup {
    ...
    private final Handler.Callback stateCallback = new Handler.Callback() {
        public boolean handleMessage(Message message) {
            if (message.what == C0369R.C0370id.zxing_prewiew_size_ready) {
                CameraPreview.this.previewSized((Size) message.obj);
                return true;
            } else if (message.what != C0369R.C0370id.zxing_camera_error) {
                return false;
            } else {
    ...
    private final SurfaceHolder.Callback surfaceCallback = new SurfaceHolder.Callback() {
        ...
        public void surfaceChanged(SurfaceHolder surfaceHolder, int i, int i2, int i3) {
            ...
            Size unused = CameraPreview.this.currentSurfaceSize = new Size(i2, i3);
    ...
    private TextureView.SurfaceTextureListener surfaceTextureListener() {
        return new TextureView.SurfaceTextureListener() {
            ...
            public void onSurfaceTextureSizeChanged(SurfaceTexture surfaceTexture, int i, int i2) {
                Size unused = CameraPreview.this.currentSurfaceSize = new Size(i, i2);
                CameraPreview.this.startPreviewIfReady();
            }
        };
    }
    ...
    public void initializeAttributes(AttributeSet attributeSet) {
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, C0369R.styleable.zxing_camera_preview);
        int dimension = (int) obtainStyledAttributes.getDimension(C0369R.styleable.zxing_camera_preview_zxing_framing_rect_width, -1.0f);
        int dimension2 = (int) obtainStyledAttributes.getDimension(C0369R.styleable.zxing_camera_preview_zxing_framing_rect_height, -1.0f);
        if (dimension > 0 && dimension2 > 0) {
            this.framingRectSize = new Size(dimension, dimension2);
        }
        this.useTextureView = obtainStyledAttributes.getBoolean(C0369R.styleable.zxing_camera_preview_zxing_use_texture_view, true);
        int integer = obtainStyledAttributes.getInteger(C0369R.styleable.zxing_camera_preview_zxing_preview_scaling_strategy, -1);
        if (integer == 1) {

...
class SQLiteAndroidDatabase {
    ...
    private void executeSqlBatchStatement(java.lang.String r18, org.json.JSONArray r19, org.json.JSONArray r20) {
        ...
        L_0x000d:
            ...
            io.sqlc.SQLiteAndroidDatabase$QueryType r9 = p006io.sqlc.SQLiteAndroidDatabase.QueryType.update     // Catch:{ Exception -> 0x0262 }
            r10 = 1
            if (r8 == r9) goto L_0x0024
            io.sqlc.SQLiteAndroidDatabase$QueryType r9 = p006io.sqlc.SQLiteAndroidDatabase.QueryType.delete     // Catch:{ Exception -> 0x0262 }
        ...
        L_0x00be:
            r9 = 0
        L_0x00bf:
            io.sqlc.SQLiteAndroidDatabase$QueryType r11 = p006io.sqlc.SQLiteAndroidDatabase.QueryType.insert     // Catch:{ Exception -> 0x025d }
        ...
        L_0x0148:
            ...
            r9 = 0
        L_0x014c:
            io.sqlc.SQLiteAndroidDatabase$QueryType r11 = p006io.sqlc.SQLiteAndroidDatabase.QueryType.begin     // Catch:{ Exception -> 0x025d }
        ...
        L_0x0168:
            ...
            r9 = 0
        L_0x0186:
            io.sqlc.SQLiteAndroidDatabase$QueryType r10 = p006io.sqlc.SQLiteAndroidDatabase.QueryType.commit     // Catch:{ Exception -> 0x025d }
        ...
        L_0x01a7:
            ...
            r9 = 0
        L_0x01c5:
            io.sqlc.SQLiteAndroidDatabase$QueryType r10 = p006io.sqlc.SQLiteAndroidDatabase.QueryType.rollback     // Catch:{ Exception -> 0x025d }
        ...
        L_0x02da:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: p006io.sqlc.SQLiteAndroidDatabase.executeSqlBatchStatement(java.lang.String, org.json.JSONArray, org.json.JSONArray):void");
    }

...
public class SQLitePlugin extends CordovaPlugin {
    ...
    public void onDestroy() {
        while (!this.dbrmap.isEmpty()) {
            ...
            try {
                this.dbrmap.get(next).f52q.put(new DBQuery());
            } catch (Exception e) {
    ...
    private void startDatabase(String str, JSONObject jSONObject, CallbackContext callbackContext) {
        ...
        this.f59cordova.getThreadPool().execute(dBRunner);
    }

    /* access modifiers changed from: private */
    public SQLiteAndroidDatabase openDatabase(String str, CallbackContext callbackContext, boolean z) throws Exception {
        try {
            File databasePath = this.f59cordova.getActivity().getDatabasePath(str);
    ...
    private void closeDatabase(String str, CallbackContext callbackContext) {
        ...
        if (dBRunner != null) {
            try {
                dBRunner.f52q.put(new DBQuery(false, callbackContext));
            } catch (Exception e) {
                if (callbackContext != null) {
    ...
    private void deleteDatabase(String str, CallbackContext callbackContext) {
        ...
        if (dBRunner != null) {
            try {
                dBRunner.f52q.put(new DBQuery(true, callbackContext));
            } catch (Exception e) {
                if (callbackContext != null) {
                    callbackContext.error("couldn't close database" + e);
                }
    ...
    public boolean deleteDatabaseNow(String str) {
        try {
            return this.f59cordova.getActivity().deleteDatabase(this.f59cordova.getActivity().getDatabasePath(str).getAbsolutePath());
        } catch (Exception e) {
    ...
    private class DBRunner implements Runnable {
        ...
        /* renamed from: q */
        final BlockingQueue<DBQuery> f52q;
        ...
        DBRunner(String str, JSONObject jSONObject, CallbackContext callbackContext) {
            ...
            this.f52q = new LinkedBlockingQueue();

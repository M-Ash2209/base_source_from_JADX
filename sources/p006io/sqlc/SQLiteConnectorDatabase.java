...
import p006io.liteglue.SQLiteConnection;
import p006io.liteglue.SQLiteConnector;
import p006io.liteglue.SQLiteStatement;
        ...
        for (int i2 = 0; i2 < length; i2++) {
            ...
            if (jSONObject != null) {
                try {
                    ...
                    jSONObject2.put(Globalization.TYPE, "success");
                ...
                jSONObject3.put(Globalization.TYPE, "error");
                JSONObject jSONObject4 = new JSONObject();
                jSONObject4.put(PushConstants.MESSAGE, str);

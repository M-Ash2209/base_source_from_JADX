...
class SQLiteGlueConnection implements SQLiteConnection {
    ...
    /* renamed from: db */
    public SQLDatabaseHandle f51db = null;
    ...
    public SQLiteGlueConnection(String str, int i) throws SQLException {
        if (str != null) {
            ...
            if (open == 0) {
                this.f51db = sQLGDatabaseHandle;
                return;
            }
            throw new SQLException("sqlite3_open_v2 failure: " + this.f51db.getLastErrorMessage(), "failure", open);
        }
        throw new SQLException("null argument", "failed", 21);
    }

    public void dispose() throws SQLException {
        SQLDatabaseHandle sQLDatabaseHandle = this.f51db;
        if (sQLDatabaseHandle != null) {
            ...
            throw new SQLException("sqlite3_close failure: " + this.f51db.getLastErrorMessage(), "failure", close);
        }
    ...
    public void keyNativeString(String str) throws SQLException {
        ...
        if (sQLDatabaseHandle != null) {
            ...
            if (keyNativeString != 0) {
                throw new SQLException("sqlite3_key failure: " + this.f51db.getLastErrorMessage(), "failure", keyNativeString);
            }
            return;
        }
        throw new SQLException("already disposed", "failed", 21);
    ...
    public SQLiteStatement prepareStatement(String str) throws SQLException {
        if (this.f51db == null) {
            ...
            throw new SQLException("sqlite3_prepare_v2 failure: " + this.f51db.getLastErrorMessage(), "failure", prepare);
        } else {
            throw new SQLException("null argument", "failed", 21);
        }
    }
    ...
    private class SQLGStatement implements SQLiteStatement {
        ...
        SQLGStatement(String str) {
            this.sql = str;
            this.sthandle = SQLiteGlueConnection.this.f51db.newStatementHandle(str);
        }
        ...
        public void bindDouble(int i, double d) throws SQLException {
            ...
            if (sQLStatementHandle != null) {
                ...
                if (bindDouble != 0) {
                    throw new SQLException("sqlite3_bind_double failure: " + SQLiteGlueConnection.this.f51db.getLastErrorMessage(), "failure", bindDouble);
                }
                return;
            }
            throw new SQLException("already disposed", "failed", 21);
        ...
        public void bindInteger(int i, int i2) throws SQLException {
            ...
            if (sQLStatementHandle != null) {
                ...
                if (bindInteger != 0) {
                    throw new SQLException("sqlite3_bind_int failure: " + SQLiteGlueConnection.this.f51db.getLastErrorMessage(), "failure", bindInteger);
                }
                return;
            }
            throw new SQLException("already disposed", "failed", 21);
        ...
        public void bindLong(int i, long j) throws SQLException {
            ...
            if (sQLStatementHandle != null) {
                ...
                if (bindLong != 0) {
                    throw new SQLException("sqlite3_bind_int64 (long) failure: " + SQLiteGlueConnection.this.f51db.getLastErrorMessage(), "failure", bindLong);
                }
                return;
            }
            throw new SQLException("already disposed", "failed", 21);
        ...
        public void bindNull(int i) throws SQLException {
            ...
            if (sQLStatementHandle != null) {
                ...
                if (bindNull != 0) {
                    throw new SQLException("sqlite3_bind_null failure: " + SQLiteGlueConnection.this.f51db.getLastErrorMessage(), "failure", bindNull);
                }
                return;
            }
            throw new SQLException("already disposed", "failed", 21);
        ...
        public void bindTextNativeString(int i, String str) throws SQLException {
            ...
            if (sQLStatementHandle == null) {
                ...
                if (bindTextNativeString != 0) {
                    throw new SQLException("sqlite3_bind_text failure: " + SQLiteGlueConnection.this.f51db.getLastErrorMessage(), "failure", bindTextNativeString);
                }
            } else {
                throw new SQLException("null argument", "failed", 21);
            }
        ...
        public boolean step() throws SQLException {
            ...
            if (sQLStatementHandle != null) {
                ...
                throw new SQLException("sqlite3_step failure: " + SQLiteGlueConnection.this.f51db.getLastErrorMessage(), "failure", step);
            }
            throw new SQLException("already disposed", "failed", 21);
        }
